...
A serverless mini app that fetches a random cloud fact from DynamoDB, asks Amazon Bedrock to rewrite it in a witty way, and returns it to a UI hosted on AWS Amplify.
...
5. **AWS Amplify Hosting**: CI/CD + hosting for the frontend.
